...
export const LocalFilePathBadge: React.FC<LocalFilePathBadgeProps> = ({ path }) => {
  ...
  return (
    <div className="relative group flex items-center gap-1.5 shrink-0">
      ...
      <a
        ...
        className="px-2.5 py-1 rounded-lg bg-indigo-950/80 hover:bg-indigo-900 border border-indigo-500/40 text-indigo-300 text-[11px] font-bold flex items-center gap-1.5 transition-all shadow-sm"
      ...
      <div className="absolute right-0 top-7 z-50 hidden group-hover:block p-2 rounded-lg bg-obsidian-950 border border-slate-700 text-[10px] font-mono text-indigo-200 whitespace-nowrap shadow-xl max-w-md truncate">
        {cleanPath}
      </div>
    </div>
  );
